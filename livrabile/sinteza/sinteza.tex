...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.88\textwidth]{figs/arhitectura_module.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.78\textwidth]{figs/schema_conexiuni.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=6.5cm]{figs/brat_real.jpg}
...
\begin{tabular}{@{}p{7.5cm}@{}r@{~}l@{}}
	Data: 10.07.2026 & Autor & \rlap{\makebox[5cm][c]{\raisebox{0.02cm}{\includegraphics[width=1.1cm]{figs/semnatura_trim.png}}}}\uline{5cm}\\[0.4cm]
